...
Borland:  \
	...
	Ring.exe \
	MatrixMultiply.exe \
	TESTHEADER_FileEditor.exe \
	TESTHEADER_Noisy.exe \
	TESTHEADER_PrintContainer.exe \
	TESTHEADER_TokenIterator.exe \
	TESTHEADER_assocGen.exe \
	TESTHEADER_SimpleGenerators.exe \
	TESTHEADER_PrintValarray.exe
...
RawStorageIterator.exe: Noisy.$(OBJEXT) RawStorageIterator.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
Noisy.$(OBJEXT): Noisy.cpp


VectorOverflow.exe: Noisy.$(OBJEXT) VectorOverflow.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
VectorInsertAndErase.exe: Noisy.$(OBJEXT) VectorInsertAndErase.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
DequeConversion.exe: Noisy.$(OBJEXT) DequeConversion.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

DequeConversion.$(OBJEXT): DequeConversion.cpp

DequeOverflow.exe: Noisy.$(OBJEXT) DequeOverflow.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
ListStability.exe: Noisy.$(OBJEXT) ListStability.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

ListStability.$(OBJEXT): ListStability.cpp

ListSpecialFunctions.exe: Noisy.$(OBJEXT) ListSpecialFunctions.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
Swapping.exe: Noisy.$(OBJEXT) Swapping.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
AssociativeBasics.exe: Noisy.$(OBJEXT) AssociativeBasics.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

AssociativeBasics.$(OBJEXT): AssociativeBasics.cpp

NoisyMap.exe: Noisy.$(OBJEXT) NoisyMap.$(OBJEXT)
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
MatrixMultiply.exe: MatrixMultiply.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_FileEditor.exe: TESTHEADER_FileEditor.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_Noisy.exe: TESTHEADER_Noisy.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_PrintContainer.exe: TESTHEADER_PrintContainer.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_TokenIterator.exe: TESTHEADER_TokenIterator.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_assocGen.exe: TESTHEADER_assocGen.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_SimpleGenerators.exe: TESTHEADER_SimpleGenerators.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_PrintValarray.exe: TESTHEADER_PrintValarray.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
