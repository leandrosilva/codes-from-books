...
Borland:  \
	...
	MinInstances.$(OBJEXT) \
	OurMin.$(OBJEXT) \
	TESTHEADER_StringConv.exe \
	TESTHEADER_ApplySequence.exe \
	TESTHEADER_Gromit.exe \
	TESTHEADER_Sortable.exe \
	TESTHEADER_Nobloat.exe \
	TESTHEADER_BearCorner.exe \
	TESTHEADER_OurMin.exe
...
BearCorner.exe: BearCorner.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

BearCorner2.exe: BearCorner2.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
StaticAssert2.exe: StaticAssert2.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
...
TESTHEADER_Urand.exe: TESTHEADER_Urand.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_StringConv.exe: TESTHEADER_StringConv.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_ApplySequence.exe: TESTHEADER_ApplySequence.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_Gromit.exe: TESTHEADER_Gromit.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_Sortable.exe: TESTHEADER_Sortable.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_Nobloat.exe: TESTHEADER_Nobloat.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_BearCorner.exe: TESTHEADER_BearCorner.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@

TESTHEADER_OurMin.exe: TESTHEADER_OurMin.cpp
	$(CPP) $(CPPFLAGS) $(EXEFLAG)$@ $^
	$@
